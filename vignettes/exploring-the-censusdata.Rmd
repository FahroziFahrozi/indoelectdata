...
IDNS2010 %>%
  select(Provinces,PopulationIDN, PopulationMen, PopulationWomen, PopulationProjection2010, PopulationProjection2035, Incomegov, Medianage, Unemployment2015) %>%
  head(10) %>%
  kable()
...
ggplot(IDNS2010[1:6,],
  ...
  theme_minimal() +
  theme(legend.position = "none") +
  labs(x = "Provinces", y = "Population Men") 
