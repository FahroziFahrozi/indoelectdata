...
```
This result above matches with the official legislative election result in Indonesia 2014, showing that PDIP party winning the most (109)
...
in this part to see the party that getting the higest number of seats in parliament, like this:
...
ggplot(aes(map_id= id), data= nat_data) + 
  ...
  labs ( title = "Total seats for provinces in Election 2014 ",
         ...
         caption= "source : Indonesia Central Bureau of Statistics")
