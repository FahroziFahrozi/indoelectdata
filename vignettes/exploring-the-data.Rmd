...
save(Legislative_Election,file="C:/Users/fahro/OneDrive/Documents/GSoC-Project/data/Legislative_Election.rdata")
```
...
save(totalvotes, file = "C:/Users/fahro/OneDrive/Documents/GSoC-Project/data/totalvotes.rdata")
```
...
save(Totalseats, file = "C:/Users/fahro/OneDrive/Documents/GSoC-Project/data/Totalseats.rdata")
```
...
# Read in shapefile of provinces
# Shapefile obtained from: http://www.info-geospasial.com/2015/10/data-shp-seluruh-indonesia.html?m=1
map <- readOGR("../Shapefile/INDONESIA_PROP.shp")
