...
@Fahrozi - see suggested change in chunk below this. You will need to add the voting data to `nat_data` that you would like to use in the plot. Each row in `nat_data` corresponds with a single region (polygon) from `nat_map`.
```{r}
library(sf)
library(stringr)
postcode <- 
